...
class IncomeExpenseRow extends StatelessWidget {
  ...
  const IncomeExpenseRow({super.key, required this.text, required this.amount});
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Poppins(text: text, size: 15.0, color: Colors.white),
        Align(
          alignment: Alignment.centerRight,
          child: Poppins(text: "$amount \$", size: 15.0, color: Colors.white),
        ),
      ],
    );
  }
...
class IncomeExpenseRowMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Poppins(text: text, size: 12.0, color: Colors.black),
        Align(
          alignment: Alignment.centerRight,
          child: Poppins(text: "$amount \$", size: 12.0, color: Colors.black),
        ),
      ],
    );
  }
      ...
      children: [
        SizedBox(
          ...
          child: MaterialButton(
            child: OpenSans(text: "Register", size: 24.0, color: Colors.white),
            onPressed: () async {
...
class TotalCalculation extends HookConsumerWidget {
  ...
  const TotalCalculation({super.key, this.size});
